...
--↓↓↓- Modified by github.com/Flyyrin for Flyyrin_BlackOut --↓↓↓-
...
RegisterServerEvent("flyyrin:vSync_blackOut_state")
AddEventHandler("flyyrin:vSync_blackOut_state", function()
    return blackout
end)

--↑↑↑- Modified by github.com/Flyyrin for Flyyrin_BlackOut --↑↑↑-

--[[  Code is excluded by github.com/Flyyrin for Flyyrin_BlackOut
